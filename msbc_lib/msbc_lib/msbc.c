...
struct sbc_frame
{
	...
	UCHAR subbands;
	UCHAR bitpool;
	UCHAR join;				/* bit number x set means joint stereo has been used in subband x */
	int scale_factor[2][8];		/* only the lower 4 bits of every element are to be used */
	unsigned short audio_sample[16][2][8];	/* raw integer subband samples in the frame */
...
//	int audio_sample;
	...
	{
		DbgPrint("data[3] != sbc_crc8(crc_header, crc_pos)\n");
		return -3;
	}
#endif
...
*/
	MUL32(res1,  _sbc_proto_8[0], (in[16] - in[64])); // Q18 = Q18 * Q0
	MULA32(res1, _sbc_proto_8[1], (in[32] - in[48]));
	MULA32(res1, _sbc_proto_8[2], in[4]);
	MULA32(res1, _sbc_proto_8[3], in[20]);
	MULA32(res1, _sbc_proto_8[4], in[36]);
	MULA32(res1, _sbc_proto_8[5], in[52]);
	t32[0] = res1>>16;
	



	MUL32(res1,   _sbc_proto_8[6], in[2]);
	MULA32(res1,  _sbc_proto_8[7], in[18]);
	MULA32(res1,  _sbc_proto_8[8], in[34]);
	MULA32(res1,  _sbc_proto_8[9], in[50]);
	MULA32(res1, _sbc_proto_8[10], in[66]);
	t32[1] = res1>>16;


	MUL32(res1,  _sbc_proto_8[11], in[1]);
	MULA32(res1, _sbc_proto_8[12], in[17]);
	MULA32(res1, _sbc_proto_8[13], in[33]);
	MULA32(res1, _sbc_proto_8[14], in[49]);
	MULA32(res1, _sbc_proto_8[15], in[65]);
	MULA32(res1, _sbc_proto_8[16], in[3]);
	MULA32(res1, _sbc_proto_8[17], in[19]);
	MULA32(res1, _sbc_proto_8[18], in[35]);
	MULA32(res1, _sbc_proto_8[19], in[51]);
	MULA32(res1, _sbc_proto_8[20], in[67]);
	t32[2] = res1>>16;
	
   
	MUL32(res1,   _sbc_proto_8[21], in[5]);
	MULA32(res1,  _sbc_proto_8[22], in[21]);
	MULA32(res1,  _sbc_proto_8[23], in[37]);
	MULA32(res1,  _sbc_proto_8[24], in[53]);
	MULA32(res1,  _sbc_proto_8[25], in[69]);
	MULA32(res1, -_sbc_proto_8[15], in[15]);
	MULA32(res1, -_sbc_proto_8[14], in[31]);
	MULA32(res1, -_sbc_proto_8[13], in[47]);
	MULA32(res1, -_sbc_proto_8[12], in[63]);
	MULA32(res1, -_sbc_proto_8[11], in[79]);
	t32[3] = res1>>16;

	MUL32(res1,   _sbc_proto_8[26], in[6]);
	MULA32(res1,  _sbc_proto_8[27], in[22]);
	MULA32(res1,  _sbc_proto_8[28], in[38]);
	MULA32(res1,  _sbc_proto_8[29], in[54]);
	MULA32(res1,  _sbc_proto_8[30], in[70]);
	MULA32(res1, -_sbc_proto_8[10], in[14]);
	MULA32(res1,  -_sbc_proto_8[9], in[30]);
	MULA32(res1,  -_sbc_proto_8[8], in[46]);
	MULA32(res1,  -_sbc_proto_8[7], in[62]);
	MULA32(res1,  -_sbc_proto_8[6], in[78]);
	t32[4] = (res1>>16);
	


    MUL32(res1,   _sbc_proto_8[31], in[7]);
	MULA32(res1,  _sbc_proto_8[32], in[23]);
	MULA32(res1,  _sbc_proto_8[33], in[39]);
	MULA32(res1,  _sbc_proto_8[34], in[55]);
	MULA32(res1,  _sbc_proto_8[35], in[71]);
	MULA32(res1, -_sbc_proto_8[20], in[13]);
	MULA32(res1, -_sbc_proto_8[19], in[29]);
	MULA32(res1, -_sbc_proto_8[18], in[45]);
	MULA32(res1, -_sbc_proto_8[17], in[61]);
	MULA32(res1, -_sbc_proto_8[16], in[77]);
	t32[5] = (res1>>16);
	MUL32(res1,   _sbc_proto_8[36], (in[8] + in[72]));
	MULA32(res1,  _sbc_proto_8[37], in[24]);
	MULA32(res1,  _sbc_proto_8[38], in[40]);
	MULA32(res1,  _sbc_proto_8[37], in[56]);
	MULA32(res1, -_sbc_proto_8[39], in[12]);
	MULA32(res1,  -_sbc_proto_8[5], in[28]);
	MULA32(res1,  -_sbc_proto_8[4], in[44]);
	MULA32(res1,  -_sbc_proto_8[3], in[60]);
	MULA32(res1,  -_sbc_proto_8[2], in[76]);
	t32[6] = (res1>>16);


	MUL32(res1,   _sbc_proto_8[35], in[9]);
	MULA32(res1,  _sbc_proto_8[34], in[25]);
	MULA32(res1,  _sbc_proto_8[33], in[41]);
	MULA32(res1,  _sbc_proto_8[32], in[57]);
	MULA32(res1,  _sbc_proto_8[31], in[73]);
	MULA32(res1, -_sbc_proto_8[25], in[11]);
	MULA32(res1, -_sbc_proto_8[24], in[27]);
	MULA32(res1, -_sbc_proto_8[23], in[43]);
	MULA32(res1, -_sbc_proto_8[22], in[59]);
	MULA32(res1, -_sbc_proto_8[21], in[75]);
...
*/
	...
	MUL32(res1, _anamatrix8[0], t32[0]); // = Q14 * Q10
	MULA32(res1, _anamatrix8[7], t32[1]);
	MULA32(res1, _anamatrix8[2], t32[2]);
	MULA32(res1, _anamatrix8[3], t32[3]);
	MULA32(res1, _anamatrix8[6], t32[4]);
	MULA32(res1, _anamatrix8[4], t32[5]);
	MULA32(res1, _anamatrix8[1], t32[6]);
	MULA32(res1, _anamatrix8[5], t32[7]);
	out[0] = (res1>>15); // Q0


	MUL32(res1, _anamatrix8[1], t32[0]);
	MULA32(res1, _anamatrix8[7], t32[1]);
	MULA32(res1, _anamatrix8[3], t32[2]);
	MULA32(res1, -_anamatrix8[5], t32[3]);
	MULA32(res1, -_anamatrix8[6], t32[4]);
	MULA32(res1, -_anamatrix8[2], t32[5]);
	MULA32(res1, -_anamatrix8[0], t32[6]);
	MULA32(res1, -_anamatrix8[4], t32[7]);
	out[1] = (res1>>15);
	...
	MUL32(res1, -_anamatrix8[1], t32[0]);
	MULA32(res1, _anamatrix8[7], t32[1]);
	MULA32(res1, _anamatrix8[4], t32[2]);
	MULA32(res1, -_anamatrix8[2], t32[3]);
	MULA32(res1, -_anamatrix8[6], t32[4]);
	MULA32(res1, _anamatrix8[5], t32[5]);
	MULA32(res1, _anamatrix8[0], t32[6]);
	MULA32(res1, _anamatrix8[3], t32[7]);
	out[2] = (res1>>15);

	MUL32(res1, -_anamatrix8[0], t32[0]);
	MULA32(res1, _anamatrix8[7], t32[1]);
	MULA32(res1, _anamatrix8[5], t32[2]);
	MULA32(res1, -_anamatrix8[4], t32[3]);
	MULA32(res1, _anamatrix8[6], t32[4]);
	MULA32(res1, _anamatrix8[3], t32[5]);
	MULA32(res1, -_anamatrix8[1], t32[6]);
	MULA32(res1, -_anamatrix8[2], t32[7]);
	out[3] = (res1>>15);
...
static int sbc_pack_frame(uint8_t * data, struct sbc_frame *frame, size_t len)
{
    ...
    ch = 0;
     //for (ch = 0; ch < frame->channels; ch++) 
     {
           for (sb = 0; sb < frame->subbands; sb++) {
                size_t produced_t;
                size_t produced_t1;
            produced_t = produced&0x7;
                produced_t1 = produced>>3;
                //if (produced % 8 == 0)
                     //data[produced / 8] = 0;
            ...
            //remove division
                if (produced_t == 0)
                     data[produced_t1] = 0;
                data[produced_t1] |= ((frame->scale_factor[ch][sb] & 0x0F) << (4 - (produced_t)));
                crc_header[crc_pos >>3] |= ((frame->scale_factor[ch][sb] & 0x0F) << (4 - (produced_t)));
    ...
    produced2 = (produced &0x07);
     if ( produced2!= 0) {
           produced += 8 - (produced2);
     }

     //return (int)(produced / 8);
     return (int)(produced >>3);
}
...
int sbc_init(sbc_t *sbc, unsigned long flags)
{
	...
	sbc->data = 0;
//    sbc->priv = ExAllocatePoolWithTag(NonPagedPool, (sizeof(struct sbc_priv) + SBC_ALIGN_MASK), SBC_POOLTAG);
	if (!sbc->priv)
		return -ENOMEM;
			   ...
			   int output_len, int *written)
{
	...
	if (!sbc->data)
	{
		sbc->size = 1024;
		sbc->data = malloc(sbc->size);
//        sbc->data = ExAllocatePoolWithTag(NonPagedPool, sbc->size, SBC_POOLTAG);
        if (!sbc->data)
        {
...
void sbc_finish(sbc_t *sbc)
{
    ...
    {
#if 0
        ExFreePoolWithTag(sbc->data, SBC_POOLTAG);
#else
        free(sbc->data);
#endif
    }		
    ...
    {
#if 0
        ExFreePoolWithTag(sbc->priv, SBC_POOLTAG);
#else
        free(sbc->priv);
#endif
    }
